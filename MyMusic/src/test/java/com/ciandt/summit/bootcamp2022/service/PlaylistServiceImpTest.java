...
class PlaylistServiceImpTest {
    ...
    void test_buscaPlaylistIdCorreto(){
        MusicaDTO mR1 = new MusicaDTO("b97e179d-76f1-44bb-a04f-1d678c1269ff", "Marseilles", new Artista("771bc41f-20dd-418b-9df1-5b01e8cf0658","Brian Eno"));
    ...
    void test_adicionarMusicaPlaylistCorreto(){
        ...
        given(playlistMusicaRepository.findByPlaylistIdAndMusicaId(p1.getId(), pR1.getData().getId())).willReturn(new ArrayList<>());
    ...
    void test_adicionarMusicaPlaylistMusicaIdIncorreto(){
        MusicaDTO mR1 = new MusicaDTO("b97e179d-76f1-44bb-a04f-1d678c1269", "Marseilles", new Artista("771bc41f-20dd-418b-9df1-5b01e8cf0658","Brian Eno"));
        PlaylistRequest pR1 = new PlaylistRequest(mR1);
        Playlist p1 = new Playlist("93f7da42-d9e5-4e50-a789-b4f406897dd7");
    ...
    void test_PayloadBodyIncorreto(){
        MusicaDTO mR1 = new MusicaDTO("b97e179d-76f1-44bb-a04f-1d678c1269ff", "", new Artista("",""));
        Musica m1 = new Musica("b97e179d-76f1-44bb-a04f-1d678c1269ff", "Marseilles", new Artista("771bc41f-20dd-418b-9df1-5b01e8cf0658","Brian Eno"));
