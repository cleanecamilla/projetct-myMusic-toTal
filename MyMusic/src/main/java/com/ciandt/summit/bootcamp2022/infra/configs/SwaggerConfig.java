...
public class SwaggerConfig {
    private static final String BASE_PACKAGE = "com.ciandt.summit.bootcamp2022.application.adapters.controllers";
    private static final String API_TITLE = "MyMusic";
    private static final String API_DESCRIPTION = "_**Rest API for song search.**_";
